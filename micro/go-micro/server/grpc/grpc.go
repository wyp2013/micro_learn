...
import (
	...
	meta "micro_learn/micro/go-micro/metadata"
	"micro_learn/micro/go-micro/registry"
	"micro_learn/micro/go-micro/server"
	"micro_learn/micro/go-micro/util/addr"
	mgrpc "micro_learn/micro/go-micro/util/grpc"
...
func (g *grpcServer) Start() error {
	...
	go func() {
		t := new(time.Ticker)
		fmt.Println(g.opts.RegisterInterval)
