...
import (
	...
	cgrpc "micro_learn/micro/go-micro/client/grpc"
	...
	"micro_learn/micro/go-micro/broker/http"
	"micro_learn/micro/go-micro/broker/memory"
	"micro_learn/micro/go-micro/broker/nats"

	// registries
	"micro_learn/micro/go-micro/registry"
	"micro_learn/micro/go-micro/registry/consul"
	"micro_learn/micro/go-micro/registry/gossip"
	"micro_learn/micro/go-micro/registry/mdns"
	rmem "micro_learn/micro/go-micro/registry/memory"

	// selectors
	"micro_learn/micro/go-micro/client/selector"
	"micro_learn/micro/go-micro/client/selector/dns"
	"micro_learn/micro/go-micro/client/selector/router"
	"micro_learn/micro/go-micro/client/selector/static"

	// transports
	"micro_learn/micro/go-micro/transport"
	tgrpc "micro_learn/micro/go-micro/transport/grpc"
	thttp "micro_learn/micro/go-micro/transport/http"
	tmem "micro_learn/micro/go-micro/transport/memory"
)
