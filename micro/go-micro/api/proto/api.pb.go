...
// source: micro_learn/micro/go-micro/api/proto/api.proto
...
func init() {
	proto.RegisterFile("micro_learn/micro/go-micro/api/proto/api.proto", fileDescriptor_api_17a7876430d97ebd)
}
