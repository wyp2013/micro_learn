...
// source: micro_learn/micro/micro/internal/usage/proto/usage.proto
...
func init() {
	proto.RegisterFile("micro_learn/micro/micro/internal/usage/proto/usage.proto", fileDescriptor_usage_7cdccb5f3bba2052)
}
