...
import (
	...
	"micro_learn/micro/go-micro/agent/command"
	"micro_learn/micro/go-micro/agent/input"
	"micro_learn/micro/go-micro/util/log"
	botc "micro_learn/micro/micro/internal/command/bot"

	proto "micro_learn/micro/go-micro/agent/proto"

	// inputs
	_ "micro_learn/micro/go-micro/agent/input/discord"
	_ "micro_learn/micro/go-micro/agent/input/slack"
	_ "micro_learn/micro/go-micro/agent/input/telegram"
)
