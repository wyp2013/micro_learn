...
import (
	ccli "micro_learn/micro/cli"
	"micro_learn/micro/go-micro"
	"micro_learn/micro/go-micro/config/cmd"
	"micro_learn/micro/micro/api"
	"micro_learn/micro/micro/bot"
	"micro_learn/micro/micro/cli"
	"micro_learn/micro/micro/new"
	"micro_learn/micro/micro/plugin"
	"micro_learn/micro/micro/proxy"
	"micro_learn/micro/micro/router"
	"micro_learn/micro/micro/server"
	"micro_learn/micro/micro/service"
	"micro_learn/micro/micro/web"

	// include usage
	_ "micro_learn/micro/micro/internal/usage"
)
