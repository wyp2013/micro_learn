...
import (
	...
	tmpl "micro_learn/micro/micro/internal/template"
	"micro_learn/micro/micro/internal/usage"
...
type config struct {
	...
	// go.micro.srv.foo
	FQDN string
	// micro_learn/micro/foo
	Dir string
	// $GOPATH/src/micro_learn/micro/foo
	GoDir string
	// $GOPATH
	GoPath string
	// Files
	...
	case "fnc":
		...
		c = config{
			...
			Comments: []string{
				...
				"go get -u micro_learn/micro/protoc-gen-micro",
